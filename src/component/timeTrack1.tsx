...
import { Button, FormControl, FormControlLabel, FormHelperText, Input, InputLabel, MenuItem, OutlinedInput, Select, Switch, TextField } from "@mui/material";
                    ...
                    <div>
                      <FormControl error={formik.touched.project && Boolean(formik.errors.project)} className="formControls">
                        ...
                        <Field
                          ...
                          onChange={(event:any) => {
                            console.log(formik.values, 'asss')
                            formik.setFieldValue("project", event.target.value)}} // Fix here
